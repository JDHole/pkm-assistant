...
// `TOOL_GROUPS` nie jest eksportowany z barrela - jedyny dawny konsument
// (`modules/onboarding/PlaybookManager.js`, sekcja „Narzędzia") zniknął razem
// z kasacją Playbook Buildera. `TOOL_GROUPS` w ogóle SKASOWANY z `PromptBuilder.ts` - nie miał
// już żadnego czytelnika (nawet wewnątrz modułu) i rozjechał się z żywą `BUILTIN_TOOL_GROUPS`
