...
test('BackstageRegistry sorts tabs by order', t => {
    ...
    registry.register({ id: 'tools', order: 30, iconFn: () => '', render() {} });
    registry.register({ id: 'skills', order: 10, iconFn: () => '', render() {} });
    registry.register({ id: 'sub-agents', order: 20, iconFn: () => '', render() {} });
