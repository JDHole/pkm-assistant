 ...
 * musi wołać `createModelForRole` z `callerSkipCache=true`.
 *
 ...
 *
 * CO PILNUJE: bez piątego argumentu ta ścieżka (jedyna kanoniczna droga konsolidacji)
...
test('runSaveSessionFlow woła createModelForRole z callerSkipCache=true', t => {
    t.regex(
        source,
