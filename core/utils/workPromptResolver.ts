/**
 * Work-prompt resolver — pure, node-safe, zero imports.
 *
 ...
 *
 * Resolution chain: per-agent override > global default > factory default.
 ...
 *
 * `brief_prompt` was removed: its value had zero production readers (the only consumer,
 * `ContextSessionGenerator`, was deleted), yet Settings→Prompt kept rendering it as a live
 * control with a present-tense description. The
