/**
 * Strażnik po źródle - blok „Secure storage" i „Approved actions"
...
test('renderApiKeysSection: przełącznik Secure storage idzie przez t()', t => {
...
test('renderApiKeysSection: oba Notice migracji idą przez t()', t => {
...
test('renderNoGoSection: "Approved actions" / "No rules saved yet." / "Remove" idą przez t()', t => {
    ...
    // Nagłówek h3 idzie przez Setting().setName().setHeading() (obsidianmd/no-manual-html-headings),
    // ale nadal przez t() - to jest sedno tego testu.
